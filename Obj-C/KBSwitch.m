...
@interface KBSwitchRoundedLayer :CALayer
@end

@implementation KBSwitchRoundedLayer
...
@interface KBSwitch ()<UIGestureRecognizerDelegate>
...
- (void)finishInit
{
    ...
    object_setClass(self.selectedBackgroundView.layer, KBSwitchRoundedLayer.class);
    ...
    object_setClass(self.titleMaskView.layer, KBSwitchRoundedLayer.class);
...
+ (Class)layerClass
{
    return [KBSwitchRoundedLayer class];
}
